...
var doubledArray = numbers.map(function(data) {
...
// A map loops through each number in numbers, multiplies it by 3, and adds it to a new array. The value of tripledArray will be the new array returned by the map.
// [3, 9, 6, 15, 30]
var tripledArray = numbers.map(function(data) {
  return data * 3
});
console.log(tripledArray);
// Describe how map is working in the example below. What will the value of oddOrEven be?
// A map takes the numbers, uses a conditional statement to check if a number is even or odd, and returns a new array 
// containing the text "even" if the number is even and the text "odd" if the number is odd
// ["odd", "odd", "even", "odd", "even"]

var oddOrEven = numbers.map(function(num) {
  if (num % 2 === 0) {
    return 'even'
  } else {
    return 'odd'
